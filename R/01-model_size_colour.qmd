...
p_size <- ggplot(tab_size) +
  stat_lineribbon(data = fits_size, aes(dist_urban, .epred), fill = "grey", .width = 0.95) +
  geom_point(aes(dist_urban, size), col = "grey40", alpha = 0.25) +
...
p_color <- ggplot(tab_size) +
  stat_lineribbon(data = fits_reflect, aes(dist_urban, .epred), fill = "grey", .width = 0.95) +
  geom_point(aes(dist_urban, avg_reflectance), col = "grey40", alpha = 0.25) +
