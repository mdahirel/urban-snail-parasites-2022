...
p_meta <- ggplot(tab_parasites) +
  stat_lineribbon(data = fits_meta, aes(size, .epred), fill = "grey", .width = 0.95) +
  geom_point(aes(size, metacercariae), col = "grey40", alpha = 0.25) +
...
p_nemhelix <- ggplot(tab_parasites) +
  stat_lineribbon(data = fits_nemhelix, aes(avg_reflectance, .epred), fill = "grey", .width = 0.95) +
  geom_point(aes(avg_reflectance, metacercariae), col = "grey40", alpha = 0.25) +
